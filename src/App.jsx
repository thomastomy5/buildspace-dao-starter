...
const App = () => {
  ...
  const token = useToken("0xe03c3b5a858f339d57d989301e5952d9c5c8892e");

  const vote = useVote("0xf5C9816c4b1884696898E79B1132C2037C4046F9");
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to BlockchainDAO</h1>
